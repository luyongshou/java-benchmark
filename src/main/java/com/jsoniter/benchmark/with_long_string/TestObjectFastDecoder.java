...
public class TestObjectFastDecoder implements JsonDecoder<TestObject> {
    ...
    static {
        ValueSetter<com.jsoniter.benchmark.with_1_string_field.TestObject> valueSetter = new ValueSetter<com.jsoniter.benchmark.with_1_string_field.TestObject>() {
            @Override
            public void set(com.jsoniter.benchmark.with_1_string_field.TestObject bean, JsonReader parser) {
